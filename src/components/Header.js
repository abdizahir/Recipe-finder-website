    ...
    return (
        <section className='relative'>
                <article className='flex items-center justify-between my-4 px-4 sm:px-8'>
                    ...
                    <button onClick={handleMunue}>
                        <img src={hamburger} alt='hamburger-img' className='md:hidden p-3 bg-neutral-200 rounded-[3px]' />
                    </button>
                    ...
                    <button className="hidden md:block cursor-pointer w-[50%] bg-neutral-900 text-neutral-0 text-preset5 font-bold rounded-lg py-2">
